...
// Carregue ANTES de authSetup.js

const USE_MOCK_DATA = true; // Mude para false quando Supabase estiver configurado
...
function badgeClass(status) {
    return 'badge-' + status.toLowerCase()
        .replace('ç','c').replace('ã','a').replace('ó','o').replace('é','e');
}

// ====== CONTROLES COMUNS (sidebar mobile + tema) ======
